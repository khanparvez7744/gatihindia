...
<section class="privacySec">
    <div class="row">
        <div class="col sm-12 text-center">
            <h2 class="hdngGatih">Privacy Policy</h2>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="Helvetica-Bold mt-4">Interpretation and Definitions</h4>
            <h4 class="Helvetica-Bold mt-4">Interpretation</h4>
            <p class="text-justify mt-3">The words of which the initial letter is capitalized have meanings defined
            ...
            <h4 class="Helvetica-Bold mt-4">Definitions</h4>
            <p class="text-justify mt-3">For the purposes of this Privacy Policy:</p>
            <ul class="text-justify mt-3">
                ...
                <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Gatif
                    Foods.</li>
                ...
                <li>Service Provider means any natural or legal person who processes the data on behalf of the Company.
                ...
                <li>Third-party Social Media Service refers to any website or any social network website through which a
                    User can log in or create an account to use the Service.</li>
                ...
                <li>Website refers to Gatif Foods, accessible from gatihfoods.com </li>
            ...
            <h4 class="Helvetica-Bold mt-4">Collecting and Using Your Personal Data</h4>
            <h4 class="Helvetica-Bold mt-4">Types of Data Collected</h4>
            <h4 class="Helvetica-Bold mt-4">Personal Data</h4>
            <p class="text-justify mt-3">While using Our Service, We may ask You to provide Us with certain personally
            ...
            <h4 class="Helvetica-Bold mt-4">Usage Data</h4>
            <p class="text-justify mt-3">
                Usage Data is collected automatically when using the Service.
            </p>
            <p class="text-justify mt-3">Usage Data may include information such as Your Device's Internet Protocol
                ...
                diagnostic data.</p>
            <p class="text-justify mt-3">When You access the Service by or through a mobile device, We may collect
                certain information automatically, including, but not limited to, the type of mobile device You use,
                Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the
                type of mobile Internet browser You use, unique device identifiers and other diagnostic data.</p>
            <p class="text-justify mt-3">We may also collect information that Your browser sends whenever You visit our
                Service or when You access the Service by or through a mobile device.</p>
            <h4 class="Helvetica-Bold mt-4">Information from Third-Party Social Media Services</h4>
            <p class="text-justify mt-3">The Company allows You to create an account and log in to use the Service
            ...
            <p class="text-justify mt-3">If You decide to register through or otherwise grant us access to a Third-Party
                Social Media Service, We may collect Personal data that is already associated with Your Third-Party
                Social Media Service's account, such as Your name, Your email address, Your activities or Your contact
                list associated with that account.</p>
            <p class="text-justify mt-3">You may also have the option of sharing additional information with the Company
                through Your Third-Party Social Media Service's account. If You choose to provide such information and
                Personal Data, during registration or otherwise, You are giving the Company permission to use, share,
                and store it in a manner consistent with this Privacy Policy.</p>
            <h4 class="Helvetica-Bold mt-4">Tracking Technologies and Cookies</h4>
            <p class="text-justify mt-3">We use Cookies and similar tracking technologies to track the activity on Our
            ...
            <ul class="text-justify mt-3">
                <li>Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You
                    can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if
                ...
                <li>Flash Cookies. Certain features of our Service may use local stored objects (or
                    ...
                    disabling, or deleting local shared objects?" available at</li>
                <li>Web Beacons. Certain sections of our Service and our emails may contain small
                ...
                <li>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on
                    Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon
                    as You close Your web browser.</li>
            </ul>
            <p class="text-justify mt-3">We use both Session and Persistent Cookies for the purposes set out below:</p>
            <ul class="text-justify mt-3">
            ...
            <p class="text-justify mt-3">For more information about the cookies we use and your choices regarding
                cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</p>
            <h4 class="Helvetica-Bold mt-4">Use of Your Personal Data</h4>
            <p class="text-justify mt-3">The Company may use Personal Data for the following purposes:</p>
            <ul class="text-justify mt-3">
                ...
                <li>For other purposes: We may use Your information for other purposes, such as data analysis,
                    ...
                    and improve our Service, products, services, marketing and your experience.</li>
            </ul>
            <p class="text-justify mt-3">We may share Your personal information in the following situations:</p>
            <ul class="text-justify mt-3">
                ...
                <li>With other users: when You share personal information or otherwise interact in the public areas with
            ...
            <h4 class="Helvetica-Bold mt-4">Retention of Your Personal Data</h4>
            <p class="text-justify mt-3">The Company will retain Your Personal Data only for as long as is necessary for
            ...
            <p class="text-justify mt-3">The Company will also retain Usage Data for internal analysis purposes. Usage
            ...
            <h4 class="Helvetica-Bold mt-4">Transfer of Your Personal Data</h4>
            <p class="text-justify mt-3">Your information, including Personal Data, is processed at the Company's
                operating offices and in any other places where the parties involved in the processing are located. It
                means that this information may be transferred to — and maintained on — computers located outside of
            ...
            <p class="text-justify mt-3">Your consent to this Privacy Policy followed by Your submission of such
                information represents Your agreement to that transfer.</p>
            <p class="text-justify mt-3">The Company will take all steps reasonably necessary to ensure that Your data
            ...
            <h4 class="Helvetica-Bold mt-4">Disclosure of Your Personal Data</h4>
            <h4 class="Helvetica-Bold mt-4">Business Transactions</h4>
            <p class="text-justify mt-3">If the Company is involved in a merger, acquisition or asset sale, Your
            ...
            <h4 class="Helvetica-Bold mt-4">Law enforcement</h4>
            <p class="text-justify mt-3">Under certain circumstances, the Company may be required to disclose Your
            ...
            <h4 class="Helvetica-Bold mt-4">Other legal requirements</h4>
            <p class="text-justify mt-3">The Company may disclose Your Personal Data in the good faith belief that such
            ...
            <h4 class="Helvetica-Bold mt-4">Security of Your Personal Data</h4>
            <p class="text-justify mt-3">The security of Your Personal Data is important to Us, but remember that no
                ...
                absolute security.</p>
            <h4 class="Helvetica-Bold mt-4">Children's Privacy</h4>
            <p class="text-justify mt-3">Our Service does not address anyone under the age of 13. We do not knowingly
                ...
                become aware that We have collected Personal Data from anyone under the age of 13 without verification
                of parental consent, We take steps to remove that information from Our servers.</p>
            <p class="text-justify mt-3">If We need to rely on consent as a legal basis for processing Your information
            ...
            <h4 class="Helvetica-Bold mt-4">Links to Other Websites</h4>
            <p class="text-justify mt-3">Our Service may contain links to other websites that are not operated by Us. If
            ...
            <p class="text-justify mt-3">We have no control over and assume no responsibility for the content, privacy
                policies or practices of any third party sites or services.</p>
            <h4 class="Helvetica-Bold mt-4">Changes to this Privacy Policy</h4>
            <p class="text-justify mt-3">We may update Our Privacy Policy from time to time. We will notify You of any
                changes by posting the new Privacy Policy on this page.</p>
            <p class="text-justify mt-3">We will let You know via email and/or a prominent notice on Our Service, prior
                to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.
            </p>
            <p class="text-justify mt-3">You are advised to review this Privacy Policy periodically for any changes.
                Changes to this Privacy Policy are effective when they are posted on this page.</p>
            <h4 class="Helvetica-Bold mt-4">Contact Us</h4>
            <p class="text-justify mt-3">If you have any questions about this Privacy Policy, You can contact us:</p>
            <p class="text-justify mt-3">By email: care@gatihindia.com</p>
        </div>
    </div>
</section>
